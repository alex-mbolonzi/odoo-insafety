...
class Property(models.Model):
    ...
    def generate_monthly_statement(self, date_from=None, date_to=None):
        ...
        for rec in self:
            ...
            # Pre-collect active contracts and their invoice lines to determine the columns
                        ...
                        for inv in invoices:
                            for line in inv.invoice_line_ids:
                                if not line.display_type:
                                    ...
                                    contract_line_amounts[name] = contract_line_amounts.get(name, 0.0) + line.price_total
